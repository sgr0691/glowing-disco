import { GraphQLSchema, FieldDefinitionNode, GraphQLNamedType, DocumentNode } from 'graphql';
/**
 * Federation Spec
 */
export declare const federationSpec: DocumentNode;
/**
 ...
 */
export declare function turnExtensionsIntoObjectTypes(ast: DocumentNode): DocumentNode;
/**
 * Removes Federation Spec from GraphQL Schema
 * @param schema
 * @param config
 */
export declare function removeFederation(schema: GraphQLSchema, { withDirectives, }: {
