import { turnExtensionsIntoObjectTypes, federationSpec, isComplexPluginOutput } from '@graphql-codegen/plugin-helpers';
import { buildASTSchema, Kind, visit } from 'graphql';
import { mergeTypeDefs } from '@graphql-toolkit/schema-merging';
import { validateGraphQlDocuments, checkValidationErrors } from '@graphql-toolkit/common';
...
async function executePlugin(options, plugin) {
    ...
    const outputSchema = schema || buildASTSchema(options.schema);
...
export { DetailedError, codegen, executePlugin, isDetailedError, mergeSchemas };
