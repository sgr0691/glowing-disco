import { isDetailedError, DetailedError, codegen } from '@graphql-codegen/core';
import { normalizeInstanceOrArray, normalizeConfig, normalizeOutputParam } from '@graphql-codegen/plugin-helpers';
...
import { resolve, join, delimiter, sep, dirname, relative } from 'path';
import { cosmiconfig, defaultLoaders } from 'cosmiconfig';
import { Command } from 'commander';
import { loadConfig } from 'graphql-config';
import { CodeFileLoader } from '@graphql-toolkit/code-file-loader';
import { loadTypedefsUsingLoaders, loadDocumentsUsingLoaders } from '@graphql-toolkit/core';
...
const loadDocuments = async (documentPointers, config) => {
    const loadedFromToolkit = await loadDocumentsUsingLoaders([new CodeFileLoader(), new GitLoader(), new GithubLoader(), new GraphQLFileLoader()], documentPointers, {
...
export { CodegenContext, cliError, createContext, ensureContext, executeCodegen, generate, init, loadContext, parseArgv, runCli };
