...
function () {
   ...
   * @private
   */
  function Schema(baseSchema, extendedSchema, typeMap, fieldsMap, typeNameMap, clientIdMap, possibleTypesMap, directivesMap) {
    var _this = this;
  ...
  _proto4._getRawType = function _getRawType(typeName) {
    ...
    if (typeof typeName === 'string') {
      ...
      if (graphQLType) {
        var _this$_typeMap$get;

        var graphQLTypeName = graphQLType.name;
        var operationType = (_this$_typeMap$get = this._typeMap.get(graphQLTypeName)) !== null && _this$_typeMap$get !== void 0 ? _this$_typeMap$get : new ObjectType(graphQLTypeName);
  ...
  _proto4.DEPRECATED__extend = function DEPRECATED__extend(document) {
    ...
    return new Schema(this._baseSchema, extendedSchema, this._typeMap, this._fieldsMap, this._typeNameMap, this._clientIdMap, this._possibleTypesMap, this._directivesMap);
  };
...
function DEPRECATED__create(baseSchema, extendedSchema) {
  ...
  return new Schema(baseSchema, (_extendedSchema = extendedSchema) !== null && _extendedSchema !== void 0 ? _extendedSchema : baseSchema, new Map(), new Map(), new Map(), new Map(), new Map(), null);
}
...
function create(baseSchema, schemaExtensionDocuments, schemaExtensions) {
  ...
  return new Schema(schema, extendedSchema, new Map(), new Map(), new Map(), new Map(), new Map(), null);
}
