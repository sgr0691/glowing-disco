...
function transformSelections(context, fragments, scope, selections, errorContext) {
  ...
  selections.forEach(function (selection) {
    ...
    if (selection.kind === 'ClientExtension' || selection.kind === 'InlineDataFragmentSpread' || selection.kind === 'InlineFragment' || selection.kind === 'ModuleImport' || selection.kind === 'Defer' || selection.kind === 'Stream') {
