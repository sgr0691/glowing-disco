...
function () {
  ...
  _proto.getAddedRemovedFiles = function getAddedRemovedFiles() {
    ...
    try {
      for (var _iterator2 = this.buffer[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
  ...
  _proto.changedFilesToJSON = function changedFilesToJSON() {
    ...
    try {
      for (var _iterator3 = this.buffer[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
