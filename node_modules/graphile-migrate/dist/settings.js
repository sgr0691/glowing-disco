...
async function parseSettings(settings, requireShadow = false) {
    ...
    const shadowConnectionString = await check("shadowConnectionString", (rawShadowConnectionString = process.env.SHADOW_DATABASE_URL) => {
        if (requireShadow) {
            if (typeof rawShadowConnectionString !== "string") {
                throw new Error("Expected a string, or for TEST_DATABASE_URL to be set");
            }
    ...
    return Object.assign(Object.assign({}, settings), { afterReset: afterReset, afterAllMigrations: afterAllMigrations, afterCurrent: afterCurrent, rootConnectionString: rootConnectionString, connectionString: connectionString, databaseOwner: databaseOwner, migrationsFolder, databaseName: databaseName, shadowConnectionString: shadowConnectionString
            ? shadowConnectionString
            : void 0, shadowDatabaseName: shadowDatabaseName ? shadowDatabaseName : void 0, placeholders });
    /* eslint-enable */
}
exports.parseSettings = parseSettings;
function getCurrentMigrationPath(parsedSettings) {
    return `${parsedSettings.migrationsFolder}/current.sql`;
}
exports.getCurrentMigrationPath = getCurrentMigrationPath;
exports.BLANK_MIGRATION_CONTENT = "-- Enter migration here\n";
